...
int main(int argc, char* argv[]) {
    ...
    sxx_test_suite_t *str = sxx_test_suite_create(pool, "tester_string", NULL, sxx_tester_string);
    ...
    sxx_test_suite_t *dso = sxx_test_suite_create(pool, "test_dso", NULL, sxx_tester_dso);

    sxx_test_framework_suite_add(framework, list);
    sxx_test_framework_suite_add(framework, str);
    sxx_test_framework_suite_add(framework, atomic);
    sxx_test_framework_suite_add(framework, mpool);
    sxx_test_framework_suite_add(framework, dso);
