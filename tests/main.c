...
sxx_bool_t list_tester(sxx_test_suite_t *suite, sxx_int32_t argc,  sxx_char_t *argv[]);
...
int main(int argc, char* argv[]) {
    ...
    sxx_test_suite_t *list = sxx_test_suite_create(pool, "list_tester", NULL, list_tester);
